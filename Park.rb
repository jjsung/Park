...
post '/sms' do
	...
	if incoming.to_s.eql?("park")
		twiml = Twilio::TwiML::Response.new do |r|
			r.Message("Format: Address, City, State")
			puts "hi"
		end
		...
		# rescue
		# 	twiml = Twilio::TwiML::Response.new do |r|
		# 	r.Message("We could not find a parking space, or you formatted the address incorrectly.")
		# 	r.Body("Format: Address, City, State")
		# 	end
		# end
		...
		begin
			...
			url= "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=#{lat},#{lng}+&radius=1000&type=parking&key=AIzaSyBJi0e7HcPXnom-skb5b_Sy7KVfrLEiYgY"
			uri = URI(url)
			...
			twiml = Twilio::TwiML::Response.new do |r|
			r.Message("Error. Please send: Address, City, State")
			end
			content_type 'text/xml'
			twiml.text
		end
